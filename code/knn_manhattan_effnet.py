...
# ---- Load saved EfficientNet-B0 features ----
data = torch.load("train_features_efficientnet_b0.pt", weights_only=False)
...
# ---- Load EfficientNet-B0 for encoding test images ----
...
print(f"Encoder: EfficientNet-B0, Features: {train_features.shape}")
print(f"{'='*60}")
