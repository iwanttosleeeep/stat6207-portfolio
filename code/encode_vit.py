...
# ---- Load pretrained ViT-B/16 and remove classification head ----
...
print(f"Encoding {len(train_files)} training images with ViT-B/16...")
train_features = []
with torch.no_grad():
...
}, "train_features_vit_b16.pt")
print("Saved to train_features_vit_b16.pt")
